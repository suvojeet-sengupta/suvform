    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <button className="w-full flex items-center gap-3 px-3 py-2 text-blue-600 bg-blue-50 rounded-lg font-medium transition-colors">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex items-end justify-between mb-8">
              <div>
                ...
                <p className="text-gray-500">Manage and analyze your active collection forms</p>
              </div>
              <div className="text-sm text-gray-500">
                Total: <span className="font-semibold text-gray-900">{forms.length}</span>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-20 bg-white border-2 border-dashed border-gray-200 rounded-3xl">
                ...
                <p className="text-gray-500 max-w-xs mx-auto mt-2">Create your first form using Gemini AI to start collecting data.</p>
                <button 
                  onClick={() => router.push("/form/create")}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {forms.map((form) => (
                  <div 
                    key={form.id} 
                    className="group bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-xl hover:border-blue-200 transition-all duration-300 flex flex-col cursor-pointer"
